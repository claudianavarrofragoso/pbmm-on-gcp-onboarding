...
* [Onboarding Category 1: Workspace Account - Domain hosted on Google Domains](https://github.com/GoogleCloudPlatform/pbmm-on-gcp-onboarding/blob/main/docs/google-cloud-onboarding.md#onboarding-category-1-workspace-email---gcp-domain)
...
To create a new Google Workspace account:
...
* Enter the info for the Google Workspace account admin and your current email address.
* Click “Next”.
...
* Check your service subscriptions: Domain Registration and Google Workspace.
...
* In the GCP console, go to IAM & Admin -> Identity & Organization.
...
* Ensure you have the permissions to perform certain admin actions in the console.
...
* Click "Cloud Identity & Organization" and validate that the task has been completed.
* Go to IAM & Admin -> IAM to validate the permissions for your organization. Make sure the name of your organization is selected. It should be displayed at the top of the screen, to the left of the Search field.
...
* Click "Create Folder".
* Enter the required information and make sure that your organization is selected under "Organization". Click "Create"
...
* On the left-side menu, go to Billing and select “My Projects”. Notice that the last project has billing disabled.
* On the Actions column, click on the “3 dots” corresponding to the project. Select “Change Billing”. 
